...
sort -u "$file_name"_unmapped_reads.txt > "$file_name"_unmapped_reads_noDup.txt

seqtk subseq "$file_name"_1.fq "$file_name"_unmapped_reads_noDup.txt > "$file_name"_human_unmapped_1.fq
seqtk subseq "$file_name"_2.fq "$file_name"_unmapped_reads_noDup.txt > "$file_name"_human_unmapped_2.fq
done
...
sort -u "$file_name"_polymorphic_reads_ids.txt > "$file_name"_polymorphic_reads_ids_noDuplicates.txt
