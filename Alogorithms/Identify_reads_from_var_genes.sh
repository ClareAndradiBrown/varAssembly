...
#Map the human unmapped reads to Pf 3D7
...
#Map the human unmapped reads to var3kb exon 1
for file in *_human_unmapped_1.fq
do
file_name=$(echo "$number_name" | cut -d"_" -f1)
...
#Check for duplication in reads identified and identify polymorphic reads
for file in *_human_unmapped_1.fq
do
file_name=$(echo "$number_name" | cut -d"_" -f1)
